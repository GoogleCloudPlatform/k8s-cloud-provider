...
func UpdateAlphaHealthCheckHook(ctx context.Context, key *meta.Key, obj *alpha.HealthCheck, m *cloud.MockAlphaHealthChecks) error {
	...
	m.Objects[*key] = &cloud.MockAlphaHealthChecksObj{Obj: obj}
	return nil
}
...
func UpdateAlphaURLMapHook(ctx context.Context, key *meta.Key, obj alpha.UrlMap, m *cloud.MockAlphaUrlMaps) error {
	...
	m.Objects[*key] = &cloud.MockAlphaUrlMapsObj{Obj: obj}
	return nil
}
...
func SetTargetGlobalForwardingRuleHook(ctx context.Context, key *meta.Key, obj *ga.TargetReference, m *cloud.MockGlobalForwardingRules) error {
	...
	m.Objects[*key].Target = obj.Target
	return nil
}
...
func SetUrlMapTargetHttpProxyHook(ctx context.Context, key *meta.Key, obj, obj *ga.UrlMapReference, m *cloud.MockTargetHttpProxies) error {
	_, err := m.Get(ctx, key)
	if err != nil {
		return &googleapi.Error{
			Code:    http.StatusNotFound,
	...
	m.Objects[*key].UrlMap = obj.UrlMap
	return nil
}

// SetUrlMapAlphaTargetHttpProxyHook defines the hook for setting the url map for a TargetHttpProxy.
func SetUrlMapAlphaTargetHttpProxyHook(ctx context.Context, key *meta.Key, obj, obj *alpha.UrlMapReference, m *cloud.MockAlphaTargetHttpProxies) error {
	_, err := m.Get(ctx, key)
	if err != nil {
		return &googleapi.Error{
			Code:    http.StatusNotFound,
