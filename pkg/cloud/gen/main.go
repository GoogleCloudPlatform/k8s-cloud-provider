...
{{- end}}
	...
	{{if .GenerateCustomOps}}
		// {{.MockWrapTypeOps}} is a type the specifies mock hooks
		// for additional non-CRUD type methods defined in
		// {{.WrapTypeOps}} interface.
		// This type is expected to contain mock hooks defined by hand (non-autogenerated).
		{{.MockWrapTypeOps}}
	{{- end}}
